...
LootWishlist.Strings = LuckyStrings.New("LootWishlist.Strings", {
    ...
    wishlist = {
        ...
        expandIcon         = "|TInterface\\Buttons\\UI-PlusButton-Up:12:12:0:0|t ",
        collapseIcon       = "|TInterface\\Buttons\\UI-MinusButton-Up:12:12:0:0|t ",
        instanceHeading    = "%s|cffffd100%s|r  (%d)%s",
        bossHeading        = "   %s|cffc9a84c%s|r  (%d)",
        noItems            = "No items",
        oneItem            = "1 item",
        manyItems          = "%d items",
        clearAll           = "Clear All",
    ...
    browser = {
        ...
        historyOn         = "Roll History",
        historyOff        = "Browsing Loot",
        historyToOn       = "Click to fill in rolls you made before installing",
        historyToOff      = "Click to go back to building your wishlist",
        historyOwnClass   = "Switch back to your class to fill in its history.",
        historyHint       = "Tick an item a bonus roll already gave you, and count the charges you spent.",
        historyRolls      = "%d roll",
        historyRollsMany  = "%d rolls",
        historyWon        = "A bonus roll gave you this",
        historyNotWon     = "Tick if a bonus roll gave you this",
        historyFewer      = "One fewer roll here",
        historyMore       = "One more roll here",
    ...
    reminders = {
        ...
        chasingRoll    = "Marked for a bonus roll",
    ...
    slash = {
        ...
        usage            = "/wishlist commands: show | hide | browse | rolls | odds | tokens | settings | add <ID> | remove <ID> | list | clear | export | import | paste | debug | reset-spec | raidinfo",
    },
})
